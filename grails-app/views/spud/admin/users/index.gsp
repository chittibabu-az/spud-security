    ...
    <tbody>
      <g:each var="user" in="${users}">
        ...
        <tr id="row_user_<%=user.id%>">
          ...
          <td align="right">
          <spAdmin:link action="delete" data-method="DELETE" method="DELETE" id="${user.id}" data-confirm="Are you sure you want to remove this user?" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></spAdmin:link>
          </td>
        </tr>
      </g:each>
    </tbody>
